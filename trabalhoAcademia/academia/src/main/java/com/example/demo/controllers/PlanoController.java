...
/*
        ...
        for (int idunidade : planoRecordDto.id_unidades()) {
            Optional<UnidadeModel> unidadeOptional = unidadeRepository.findById(unidadeRecordDto.empresa());
            unidadeOptional.ifPresent(unidades::add);
        }
*/


        planoModel.setTipoplano(planoRecordDto.tipo_plano());
        planoModel.setValorplano(planoRecordDto.valor_plano());
        //planoModel.setUnidades(unidadeOptional.);
