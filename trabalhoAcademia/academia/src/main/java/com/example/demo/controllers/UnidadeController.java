...
public class UnidadeController {
    ...
    public ResponseEntity<UnidadeModel> saveUnidade(@RequestBody @Valid UnidadeRecordDto unidadeRecordDto) {
        ...
        Optional<EmpresaModel> empresaOptional = empresaRepository.findById(unidadeRecordDto.empresa());
        ...
        unidadeModel.setRua(unidadeRecordDto.rua());
        unidadeModel.setBairro(unidadeRecordDto.bairro());
        unidadeModel.setCep(unidadeRecordDto.cep());
        unidadeModel.setTelefoneUnidade(unidadeRecordDto.telefone_unidade());
